...
const Process: React.FC = () => {
  ...
  return (
    <section id="process" className="section-padding bg-white text-[#111] relative overflow-hidden z-10 min-h-[50vh] flex flex-col justify-center">
          ...
          {PROCESS_STEPS.map((step: ProcessStep, index: number) => (
            <Reveal key={step.id} delay={index * 150}>
              <div className="flex flex-col h-full border-t border-[#000000]/10 pt-8 mt-8 lg:mt-0 lg:border-t-0 lg:pt-0">
                 <span className="text-fluid-display font-serif italic text-[#000000]/10 leading-none mb-8 md:mb-12 block select-none tracking-tighter">
                   {step.id}
                 </span>
                 <h3 className="text-fluid-h3 font-serif text-[#111] mb-4 tracking-tight">
                   {step.title}
                 </h3>
