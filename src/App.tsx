...
export default function App() {
  return (
    <div className="w-full min-h-screen bg-cream text-charcoal selection:bg-charcoal selection:text-cream">
      ...
      {/* Section 4: Process */}
      <section className="min-h-screen grid grid-cols-1 md:grid-cols-12 bg-sage text-charcoal border-t border-charcoal/20">
        ...
        <div className="md:col-span-4 relative h-[50vh] md:h-screen bg-[#dcdcd2] overflow-hidden">
          ...
          <div className="absolute inset-0 p-8 pt-24 flex items-center justify-center">
             {/* Background texture */}
             <img 
